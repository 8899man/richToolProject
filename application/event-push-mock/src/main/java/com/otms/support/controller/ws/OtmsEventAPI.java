...
public class OtmsEventAPI {
    ...
    @InboundLog(value = APISource.ORDER_EVENT, method = "PUT")
    ...
    @InboundLog(value = APISource.JOB_SHEET_EVENT, method = "POST")
    ...
    @InboundLog(value = APISource.BILLING_EVENT, method = "PUT")
